 ...
 */
final class Version20221128230817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(15) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, line1 VARCHAR(255) NOT NULL, line2 VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE brand (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, path_image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE content_shopping_cart (id INT AUTO_INCREMENT NOT NULL, basket_id INT NOT NULL, product_id INT DEFAULT NULL, quantity INT NOT NULL, price NUMERIC(7, 2) NOT NULL, tva NUMERIC(4, 2) NOT NULL, INDEX IDX_2970F2E71BE1FB52 (basket_id), INDEX IDX_2970F2E74584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, gender_id INT NOT NULL, address_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, date_of_birth DATETIME NOT NULL, registration_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_81398E09F85E0677 (username), UNIQUE INDEX UNIQ_81398E09E7927C74 (email), INDEX IDX_81398E09708A0E0 (gender_id), INDEX IDX_81398E09F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, brand_id INT NOT NULL, promotion_id INT DEFAULT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price_excl_vat NUMERIC(7, 2) NOT NULL, active TINYINT(1) NOT NULL, date_added DATETIME NOT NULL, tva NUMERIC(4, 2) NOT NULL, INDEX IDX_D34A04AD44F5D008 (brand_id), INDEX IDX_D34A04AD139DF194 (promotion_id), INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
